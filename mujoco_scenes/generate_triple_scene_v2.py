...
DLO_OUTPUT_NAME = "triple_lite6_cable_routing_dlo_v2.xml"
...
def add_cameras_to_arms(worldbody: ET.Element) -> None:
    for prefix in ("r1_", "r2_", "r3_"):
        ...
        # was causing the camera to face backward.)
        mount = ET.SubElement(
            link6,
            "body",
            name=f"{prefix}d435i",
...
def generate(
    ...
    model_name = "triple_lite6_cable_routing_dlo" if layout == "dlo" else "triple_lite6_cable_routing"
